...
Rcpp::List compute_sr_sparsity_loss(const double mve_sr, const arma::vec& mu, const arma::mat& sigma, const arma::vec& mu_sample, const arma::mat& sigma_sample, unsigned int max_card, const double greedy_perc, bool do_checks);
