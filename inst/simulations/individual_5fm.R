...
compute_simulation_results(n_obs = n_obs,
                           ...
                           seed = 123,
                           save_results = TRUE,
                           file_name = "results_individual_5fm_n20.rds")
...
evaluation <- evaluate_simulation_results(f_name = "individual_5fm_n20",
                                          N = n_returns,
                                          mve_sr = mve_sr,
...
compute_simulation_results(n_obs = n_obs,
                           ...
                           seed = 123,
                           save_results = TRUE,
                           file_name = "results_individual_5fm_n20_weak05.rds")
...
####* Evaluate the results
evaluation <- evaluate_simulation_results(f_name = "individual_5fm_n20_weak05",
                                          N = n_returns,
                                          mve_sr = mve_sr,
                                          mve_sr_cardk = mve_sr_cardk)
