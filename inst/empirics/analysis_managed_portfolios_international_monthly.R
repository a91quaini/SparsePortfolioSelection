# Out-of-sample analysis for international monthly managed portfolios using run_oos_evaluation.
# Mirrors the US monthly script but loads international data via load_data(..., type = "International", frequency = "monthly").
...
RNG_SEED <- 12345
W_IN <- 160             # in-sample length (months) [80 | 120 | 160]
...
OUT_DIR <- file.path("inst", "empirics", "results", "managed_portfolios_international_monthly")
FIG_DIR <- file.path("inst", "empirics", "figures", "managed_portfolios_international_monthly")
