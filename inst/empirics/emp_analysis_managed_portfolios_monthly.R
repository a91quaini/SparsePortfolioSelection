# emp_analysis_managed_portfolios_monthly.R
#
# Out-of-sample analysis for US managed portfolios (monthly).
...
MISSINGS <- "median"
N_ASSETS_REQUEST <- 360L   # total currently ~355; will cap automatically
RNG_SEED <- 12345
